...
class AddMachineOtherProvider with ChangeNotifier {
  ...
  // List<TechnicianListModel> _techList = [];
  // List<TechnicianListModel> get techList => _techList;

  // List<String> _techNameList = [];
  ...
  // TechnicianListModel selectedModel = TechnicianListModel(techName: "", id: "");
  void changeTechnicianType(String value) {
    _ctlTechnician.text = value;
    // selectedModel =
    //     _techList.firstWhere((element) => element.techName == value);
    notifyListeners();
  }
  ...
  Future addNewComlain(BuildContext context) async {
    ...
    var result =
        await complaintRepository.addOtherMachineComplain(context, passedData);
