...
class AddAmcMachineScreen extends StatefulWidget {
  const AddAmcMachineScreen({super.key});

  @override
  State<AddAmcMachineScreen> createState() => _AddAmcMachineScreenState();
}

class _AddAmcMachineScreenState extends State<AddAmcMachineScreen> {
  final GlobalKey<FormState> _formKey = GlobalKey();
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      var provider = Provider.of<AddMachineAMCProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: commonAppBar(
            context: context, heading: "ADD NEW AMC (AIRO TECHENTERPRICES)"),
          ...
          child: Card(
            ...
            child: Column(
              children: [
                ...
                Consumer<AddMachineAMCProvider>(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    StepperTextField(
                                      controllerValue: provider.ctlCompressorHP,
                                      hintValue: 'HP',
                                      validate: (val) {
                                        if (val!.isEmpty) {
                                          return "Field is required.";
                                  ...
                                  ? Column(
                                      children: [
                                        ...
                                        StepperTextField(
                                          ...
                                          onTap: () {
                                            provider.getComplainDate(context);
                                          },
                                        ...
                                        ExpandedDropDownWidget(
                                            labelText: 'Select Complain Type',
                                  ...
                                  : Column(
                                      children: [
                                        GridView.builder(
                                            ...
                                            itemCount: provider
                                                .ctlTextControllerList.length),
                                        StepperTextField(
                                          controllerValue: provider.ctlAMCDesc,
                          ...
                          AppButton(
                            ...
                            onTap: provider.isBtnLoading
                                ...
                                : () {
                                    ...
                                    if (provider.ctlAmcType.text.isNotEmpty) {
